...
def GetPublicKey():
    try:
        beneficiaryKeyHex = os.environ['BENEFICIARY_PUBLIC_KEY_BASE64']
        key = base64.b64decode(beneficiaryKeyHex)
...
def TestEncryptedOutput(symmetricKey):
    try:
        ...
        ZipOutput()
        with open('/iexec_out/' + os.env['TASK_ID'] +'_result.zip', 'rb') as input:
...
if __name__ == '__main__':
    ...
    if pubKeyObj is None:
        #TODO: Don't copy results if uploaded to dropbox
