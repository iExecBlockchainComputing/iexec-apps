...
tasks["task_nodejs"] = {
    stage ("Build NodeJs Hello World"){
        def nativeImage = buildSimpleDocker_v2(dockerfileDir: 'cloud-computing/nodejs-hello-world',
...
tasks["task_go"] = {
    stage ("Build Go Hello World"){
        def nativeImage = buildSimpleDocker_v2(dockerfileDir: 'cloud-computing/go-hello-world',
...
tasks["task_python"] = {
    stage ("Build Python Hello World"){
        def nativeImage = buildSimpleDocker_v2(dockerfileDir: 'offchain-computing/offchain-python-hello-world',
