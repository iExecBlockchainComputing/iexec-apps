...
import TakeOffIcon from "../assets/train.png";
...
export default function Home({
 ...
 const duration = (_arrivalTime && _departureTime)?moment.duration(_arrivalTime.diff(_departureTime)):'';
  ...
  return (
    ...
    >
       <ClipLoader color={color} loading={loading}  size={15} > <span className="trip-locations">Loading... </span> </ClipLoader >
          ...
          <div className="flightResults-wrapper">
            <div className="card shadow-none flight-card-lg">
              ...
              <div className="row" style={{ marginTop: 20 }}>
                ...
                >
                  <span className="trip-locations">
                    Amount for Train Arrived On Time:
                    {AmountForAsPlanned
                ...
                >
                  <span className="trip-locations">
                    Amount for Train Delayed or Late:
                    {AmountForCanceled
